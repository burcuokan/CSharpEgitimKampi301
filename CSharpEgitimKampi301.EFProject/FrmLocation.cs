...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmLocation : Form
    {
        ...
        private void FrmLocation_Load(object sender, EventArgs e)
        {
            ...
            CmbGuiede.DisplayMember = "FullName";
            CmbGuiede.ValueMember = "Guideid";
            CmbGuiede.DataSource = values;
        }
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            location.Guideid = int.Parse(CmbGuiede.SelectedValue.ToString());
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            updatedValue.Guideid = int.Parse(CmbGuiede.SelectedValue.ToString());
            db.SaveChanges();
